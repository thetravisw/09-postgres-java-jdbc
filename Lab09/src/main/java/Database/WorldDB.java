...
public class WorldDB {
    ...
    private static final String GET_CITIES_COUNTRY =
            "SELECT * FROM city " +
                    ...
                    "WHERE country.code = ?";
    private static final String GET_CITIES_NAMED4_COUNTRY =
            "SELECT * FROM city " +
                    "JOIN country ON city.name=country.name";
    private static final String GET_PALINDROMES =
            "SELECT * FROM city" +
    ...
    public List<City> getCitiesNamedAfterCountries() {
        List<City> cities = new ArrayList<>();
        try {PreparedStatement sql = this.conn.prepareStatement(GET_CITIES_NAMED4_COUNTRY);
            ...
            System.out.println("SQL Exception.  Debugging that is gonna suck.");
        }
        return cities;
    }
    ...
    public List<City> getPallindromicCities() {
        List<City> cities = new ArrayList<>();

        try {
            PreparedStatement sql = this.conn.prepareStatement(GET_PALINDROMES);
            ...
            System.out.println("haha.  You're boned!");
        }
    }
}